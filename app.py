...
indicators = {
    ...
    "Aggressor Characteristics":{
        ...
        "There are prior or current violations":["No","Yes","Unknown"],
        "There are prior incidents of assaults":["No","Yes","Unknown"],
        "History of gender-based violence against other partners":["No","Yes","Unknown"],
        "Aggressor has mental disorder":["No","Yes","Unknown"],
        "Suicidal ideation history":["No","Yes","Unknown"],
    ...
    "Aggravating Circumstances":{
        ...
        "Intent to end relationship":["No","Yes","Unknown"],
        "Victim believes aggressor could kill":["No","Yes","Unknown"]
    }
}
...
def calculate_score():
    severity = {
        ...
        "Work or economic problems":1,"Legal problems":1,"Both":2
    }
    score = 0
